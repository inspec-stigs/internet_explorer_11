...
# impacts
title 'V-46549 - Internet Explorer Processes Restrict ActiveX Install must be enforced (Explorer).'
control 'V-46549' do
  impact 0.5
  ...
  tag 'stig', 'V-46549'
  tag severity: 'medium'
  tag checkid: 'C-49721r3_chk'
  tag fixid: 'F-50325r1_fix'
  tag version: 'DTBI1010-IE11'
  tag ruleid: 'SV-59413r1_rule'
