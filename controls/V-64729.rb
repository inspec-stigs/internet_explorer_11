...
control 'V-64729' do
  ...
  tag fixtext: 'Open Internet Explorer. From the menu bar, select "Tools". From the "Tools" drop-down menu, select "Internet Options". From the "Internet Options" window, select the "Advanced" tab, from the "Advanced" tab window scroll down to the "Security" category. Uncheck "Use SSL 2.0" and "Use SSL 3.0" options.

Set the policy value for Computer Configuration >> Administrative Templates >> Internet Explorer >> Security Features >> "Allow fallback to SSL 3.0 (Internet Explorer)" to "Enabled", and select "No Sites" from the drop-down box. 
