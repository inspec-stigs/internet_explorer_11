...
# impacts
title 'V-46731 - Internet Explorer Processes for Zone Elevation must be enforced (iexplore).'
control 'V-46731' do
  impact 0.5
  ...
  tag 'stig', 'V-46731'
  tag severity: 'medium'
  tag checkid: 'C-49873r2_chk'
  tag fixid: 'F-50487r1_fix'
  tag version: 'DTBI614-IE11'
  tag ruleid: 'SV-59595r1_rule'
