...
# impacts
title 'V-46723 - Internet Explorer Processes for MK protocol must be enforced (Explorer).'
control 'V-46723' do
  impact 0.5
  ...
  tag 'stig', 'V-46723'
  tag severity: 'medium'
  tag checkid: 'C-49865r2_chk'
  tag fixid: 'F-50479r1_fix'
  tag version: 'DTBI600-IE11'
  tag ruleid: 'SV-59587r1_rule'
