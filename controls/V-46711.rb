...
# impacts
title 'V-46711 - Internet Explorer Processes for MIME handling must be enforced (Explorer).'
control 'V-46711' do
  impact 0.5
  ...
  tag 'stig', 'V-46711'
  tag severity: 'medium'
  tag checkid: 'C-49853r2_chk'
  tag fixid: 'F-50467r1_fix'
  tag version: 'DTBI592-IE11'
  tag ruleid: 'SV-59575r1_rule'
