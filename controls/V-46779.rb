...
# impacts
title 'V-46779 - Internet Explorer Processes for Restrict File Download must be enforced (Explorer).'
control 'V-46779' do
  impact 0.5
  ...
  tag 'stig', 'V-46779'
  tag severity: 'medium'
  tag checkid: 'C-49877r2_chk'
  tag fixid: 'F-50529r1_fix'
  tag version: 'DTBI635-IE11'
  tag ruleid: 'SV-59645r1_rule'
