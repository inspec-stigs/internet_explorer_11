...
# impacts
title 'V-46719 - Internet Explorer Processes for MIME sniffing must be enforced (iexplore).'
control 'V-46719' do
  impact 0.5
  ...
  tag 'stig', 'V-46719'
  tag severity: 'medium'
  tag checkid: 'C-49861r2_chk'
  tag fixid: 'F-50475r1_fix'
  tag version: 'DTBI597-IE11'
  tag ruleid: 'SV-59583r1_rule'
