...
# impacts
title 'V-46789 - Internet Explorer Processes for restricting pop-up windows must be enforced (Explorer).'
control 'V-46789' do
  impact 0.5
  ...
  tag 'stig', 'V-46789'
  tag severity: 'medium'
  tag checkid: 'C-49885r2_chk'
  tag fixid: 'F-50539r1_fix'
  tag version: 'DTBI647-IE11'
  tag ruleid: 'SV-59655r1_rule'
