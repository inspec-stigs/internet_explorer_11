...
# impacts
title 'V-46553 - Internet Explorer Processes Restrict ActiveX Install must be enforced (iexplore).'
control 'V-46553' do
  impact 0.5
  ...
  tag 'stig', 'V-46553'
  tag severity: 'medium'
  tag checkid: 'C-49723r3_chk'
  tag fixid: 'F-50327r1_fix'
  tag version: 'DTBI1020-IE11'
  tag ruleid: 'SV-59417r1_rule'
