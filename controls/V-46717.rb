...
# impacts
title 'V-46717 - Internet Explorer Processes for MIME sniffing must be enforced (Explorer).'
control 'V-46717' do
  impact 0.5
  ...
  tag 'stig', 'V-46717'
  tag severity: 'medium'
  tag checkid: 'C-49859r2_chk'
  tag fixid: 'F-50473r1_fix'
  tag version: 'DTBI596-IE11'
  tag ruleid: 'SV-59581r1_rule'
