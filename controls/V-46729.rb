...
# impacts
title 'V-46729 - Internet Explorer Processes for Zone Elevation must be enforced (Explorer).'
control 'V-46729' do
  impact 0.5
  ...
  tag 'stig', 'V-46729'
  tag severity: 'medium'
  tag checkid: 'C-49871r2_chk'
  tag fixid: 'F-50485r1_fix'
  tag version: 'DTBI612-IE11'
  tag ruleid: 'SV-59593r1_rule'
