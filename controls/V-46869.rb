...
# impacts
title 'V-46869 - Internet Explorer Processes for Notification Bars must be enforced (iexplore).'
control 'V-46869' do
  impact 0.5
  ...
  tag 'stig', 'V-46869'
  tag severity: 'medium'
  tag checkid: 'C-49939r2_chk'
  tag fixid: 'F-50605r1_fix'
  tag version: 'DTBI835-IE11'
  tag ruleid: 'SV-59735r1_rule'
