...
# impacts
title 'V-46981 - Dragging of content from different domains across windows must be disallowed (Internet zone).'
control 'V-46981' do
  impact 0.5
  ...
  tag 'stig', 'V-46981'
  tag severity: 'medium'
  tag checkid: 'C-49973r2_chk'
  tag fixid: 'F-50707r1_fix'
  tag version: 'DTBI990-IE11'
  tag ruleid: 'SV-59847r1_rule'
  tag fixtext: 'Set the policy value for Computer Configuration -> Administrative Templates -> Windows Components -> Internet Explorer-> Internet Control Panel-> Security Page-> Internet Zone Enable dragging of content from different domains across windows to Enabled, and select Disabled from the drop-down box.   '
