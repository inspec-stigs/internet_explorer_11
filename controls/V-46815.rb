...
control 'V-46815' do
  ...
  tag fixtext: 'Set the policy value for User Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Turn on the auto-complete feature for user names and passwords on forms to Disabled.   '
  tag checktext: 'The policy value for User Configuration -> Administrative Templates -> Windows Components -> Internet Explorer -> Turn on the auto-complete feature for user names and passwords on forms must be Disabled. 
